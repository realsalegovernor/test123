const contract_address = "0x8f37A8Fde3aef7496970F9EA3aA05BeaD1502a11";
...
[
	...
	},
	{
		"inputs": [
			{
				"internalType": "uint256",
				"name": "_poolPercentage",
				"type": "uint256"
			}
		],
		"name": "_setPoolPercentage",
		"outputs": [],
		"stateMutability": "nonpayable",
		"type": "function"
	},
	...
	},
	{
		"inputs": [
			{
				"internalType": "uint256",
				"name": "_unstakepercentage",
				"type": "uint256"
			}
		],
		"name": "_setUnStakePercentage",
		"outputs": [],
		"stateMutability": "nonpayable",
		"type": "function"
	},
	...
	},
	{
		...
		"name": "getTotalIndividualStakeAmount",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "",
...
async function connectWallet() { 
    ...
    tokenContract.allowance.call(web3.eth.defaultAccount, contract_address, (error,result) => {
        ...
        console.log("Contract can spend: " + result);
        if (result < 50000000000000000000000000){
            $('#approvalRequired').text(result + " (Approval required)");
        }
        else{
            $('#approvalRequired').text("Approved");
        }
...
function setStake() {
    let stakeAmount = Math.floor($('#add_stake').val()*1000000000000000000);
...
function removeStake() {
    let stakeAmount = Math.floor($('#remove_stake').val()*1000000000000000000);
    console.log(stakeAmount);
